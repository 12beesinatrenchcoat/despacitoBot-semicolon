...
client.on("message", msg=>{
    if(str.toLowercase(msg.content) === "this is so sad play despacito"){
        var embed = despacito.getRandom(); //calls function in despacito.js
        msg.reply("i hope this cheers you up.",{
            embed: embed
        });
    }
    if (str.toLowercase(msg.content) === "despacito help"){
    ...
    if (str.toLowercase(msg.content) === "despacito about"){
    ...
    if (str.toLowercase(msg.content) === "despacito playlist"){
